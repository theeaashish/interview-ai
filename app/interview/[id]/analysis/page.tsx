        ...
        <div className="md:col-span-3 space-y-6">
          ...
          {activeQuestion.answer ? (
            ...
            <div className="bg-[var(--input-bg)] rounded-lg shadow-md p-6 text-center">
              <p className="text-gray-500 mb-2">Answer this question to see analysis.</p>
              {interview.status === 'in-progress' && (
                <MainButton
                text="Continue Interview"
                color="blue"
          ...
          <div className="flex justify-between">
            <PreviousNextBtn position="mr-1" path="M12.707 5.293a1 1 0 010 1.414L9.414 10l3.293 3.293a1 1 0 01-1.414 1.414l-4-4a1 1 0 010-1.414l4-4a1 1 0 011.414 0z" text="Previous Question" disabled={activeQuestionIndex === 0} onClick={() => setActiveQuestionIndex(prev => Math.max(0, prev - 1))} />
            <PreviousNextBtn position="ml-1" path="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" text="Next Question" disabled={activeQuestionIndex === interview.questions.length - 1} onClick={() => setActiveQuestionIndex(prev => Math.min(interview.questions.length - 1, prev + 1))} />
          </div>
        </div>
      </div>
    </div>
